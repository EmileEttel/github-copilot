            ...
            <div className={styles.editorWindow}>
                ...
                <div className={styles.editorTextArea}>
                    ...
                    <div className={styles.editorEditorDiv}>
                        <EditorTerminal underText='1' height={["554px", 0]} charsize={[104, 0]} segments='6' linenumber={props.linenumber} info_one={props.info_one} info_two={props.info_two} info_three={props.info_three} tabs={props.tabs} border="square" theme="white" width="auto"/>
                    </div>
                </div>

...
function FirstSectionTripleEditor() {
    ...
    const one_info_two = [new Info('function ', purple), new Info('collaborators_map', blue), new Info('(json: any): ', black), new Info('Map', blue), new Info('<string, ', black), new Info('Set', blue), new Info('<string>> {', black)];
        ...
        <div className={styles.tripleEditorWhole}>
            <div className={styles.tripleEditorThird}>
                <div className={styles.thirdTextDiv}>
                    ...
                    <EditorTerminal height="554px" charsize={65} segments='7' linenumber="24" info_one={one_info_one} info_two={one_info_two} info_three={one_info_three} tabs={one_tabs} border="rounded" theme="white" />
                </div>
            </div>
            <div className={styles.tripleEditorThird}>
                <div className={styles.thirdTextDiv}>
                    <EditorTerminal height="457px" charsize={75} segments='20' linenumber="16" info_one={two_info_one} info_two={two_info_two} info_three={two_info_three} tabs={two_tabs} border="rounded" theme="white" />
                    <p className={styles.thirdText}>
            ...
            <div className={styles.tripleEditorThird}>
                <div className={styles.thirdTextDiv}>
                    ...
                    <EditorTerminal height="607px" charsize={24} segments='3' linenumber="12" info_one={three_info_one} info_two={three_info_two} info_three={three_info_three} tabs={three_tabs} border="rounded" theme="white" />
                </div>
            </div>
        </div>
    )
